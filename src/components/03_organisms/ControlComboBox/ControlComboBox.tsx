...
export default function ControlComboBox({
  ...
  return (
    <div className="w-[268px] md:w-[632px] lg:w-[996px]" onClick={onClick}>
      <div className="hover:u-list-options-shadow relative rounded-lg">
        <input
          ref={inputTextRef}
          type={inputType}
          id={id}
        ...
        <div className="absolute right-4 top-[14px] z-20 size-[20px] text-gray-500 duration-300 peer-focus:peer-placeholder-shown:rotate-180 peer-focus:peer-placeholder-shown:text-gray-600">
