...
export default function InfoUserProfile({ text = '', selected = false }: Props) {
  if (selected) {
    return (
      <div className="flex h-[22px] items-center justify-between gap-2 border text-gray-800">
  ...
  return (
    <div className="flex h-[22px] items-center justify-between gap-2 border text-gray-500 hover:font-extrabold hover:text-gray-800">
      <AppIcon16x16 iconName="icon-profile" />
